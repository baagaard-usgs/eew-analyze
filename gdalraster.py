...
def resample(filename, gridSpecs):
    ...
    :type filename: str
    :param filename: Filename with raster

    :type gridSpecs: dict
    :param gridSpecs: Grid specifications to match.
    """
    ...
    originLon = gridSpecs["longitude_min"]
    originLat = gridSpecs["latitude_max"]
...
def write(filename, values, gridSpecs):
    ...
    :type filename: str
    :param filename: Filename for GeoTiff raster.

    :type values: List
    :param values: List of tuples with value name and Numpy array.

    :type gridSpects: dict
    :param gridSpecs: Grid specification.
    """
    wgs84 = osr.SpatialReference()
    wgs84.ImportFromEPSG(4326)
    numLon = gridSpecs["num_longitude"]
