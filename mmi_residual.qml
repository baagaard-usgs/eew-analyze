    ...
    <rasterrenderer opacity="1" alphaBand="0" classificationMax="1.5" classificationMinMaxOrigin="User" band="1" classificationMin="-1.5" type="singlebandpseudocolor">
      ...
      <rastershader>
        <colorrampshader colorRampType="DISCRETE" clip="0">
          ...
          <item alpha="255" value="-0.75" label="-1.0 - -0.75" color="#f4a582"/>
          <item alpha="255" value="-0.5" label="-0.75 - -0.50" color="#f5c1a9"/>
          <item alpha="255" value="-0.25" label="-0.50 - -0.25" color="#f6dcd0"/>
          <item alpha="255" value="0.25" label="-0.25 - 0.25" color="#f7f7f7"/>
          <item alpha="255" value="0.5" label="0.25 - 0.50" color="#d6e7ef"/>
          <item alpha="255" value="0.75" label="0.50 - 0.75" color="#b4d6e7"/>
          <item alpha="255" value="1" label="0.75 - 1.0" color="#92c5de"/>
          <item alpha="255" value="1.25" label="1.0 - 1.25" color="#63a9cf"/>
          <item alpha="255" value="1.5" label="1.25 - 1.50" color="#348dc0"/>
